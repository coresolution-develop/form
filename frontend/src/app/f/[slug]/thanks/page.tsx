...
export default async function ThanksPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-gray-50 px-4 text-center">
      <div className="rounded-2xl border border-gray-200 bg-white px-8 py-12">
        <h1 className="text-2xl font-bold text-gray-900">응답해 주셔서 감사합니다 🎉</h1>
        {title && <p className="mt-2 text-sm text-gray-600">‘{title}’에 정상적으로 제출되었습니다.</p>}
